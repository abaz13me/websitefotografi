document.addEventListener("DOMContentLoaded", () => {
  ...
  const wonders = [
    {
      ...
      description:
        "Kompleks reruntuhan peradaban Maya yang megah dengan piramida El Castillo sebagai pusatnya.",
      full_description:
        "Chichen Itza adalah situs arkeologi besar dari peradaban Maya di Semenanjung Yucatán, Meksiko. Piramida El Castillo yang ikonik mendominasi pusat situs dan berfungsi sebagai kuil untuk dewa Kukulkan.",
      facts: [
    ...
    },
    {
      ...
      description:
        "Patung Art Deco Yesus Kristus raksasa yang berdiri megah di puncak Gunung Corcovado.",
      full_description:
        "Patung Kristus Penebus adalah simbol Kekristenan di seluruh dunia dan ikon budaya Rio de Janeiro dan Brasil. Patung setinggi 30 meter ini menghadap ke kota dari puncak Gunung Corcovado.",
      facts: [
    ...
    },
    {
      ...
      description:
        "Amfiteater oval raksasa di pusat kota Roma, simbol ikonik dari Kekaisaran Romawi.",
      full_description:
        "Colosseum adalah amfiteater terbesar yang pernah dibangun, digunakan untuk kontes gladiator, pertunjukan publik, dan drama. Meskipun sebagian besar hancur, bangunan ini tetap menjadi simbol kekuatan Roma Kuno.",
      facts: [
    ...
    },
    {
      ...
      description:
        "Serangkaian benteng pertahanan kuno yang membentang ribuan kilometer di Tiongkok utara.",
      full_description:
        "Tembok Besar Tiongkok dibangun selama berabad-abad untuk melindungi kekaisaran Tiongkok dari invasi nomaden. Ini bukan satu tembok tunggal, melainkan jaringan tembok dan benteng yang luas.",
      facts: [
    ...
    },
    {
      ...
      description:
        "Situs benteng Inca abad ke-15 yang terletak tinggi di Pegunungan Andes, Peru.",
      full_description:
        "Machu Picchu adalah pencapaian arsitektur yang luar biasa dari Kekaisaran Inca. Terkenal dengan dinding batu keringnya yang canggih, situs ini ditinggalkan sekitar satu abad setelah pembangunannya.",
      facts: [
    ...
    },
    {
      ...
      description:
        "Kota arkeologi yang terkenal dengan arsitektur pahatan batu dan sistem saluran airnya.",
      full_description:
        "Petra, yang juga dikenal sebagai Kota Mawar, adalah keajaiban arkeologi di Yordania selatan. Bangunan paling terkenal adalah Al-Khazneh (Perbendaharaan), yang diukir langsung pada tebing batu pasir.",
      facts: [
    ...
    },
    {
      ...
      description:
        "Mausoleum marmer putih gading yang indah di Agra, simbol cinta abadi.",
      full_description:
        "Taj Mahal dibangun oleh kaisar Mughal Shah Jahan untuk mengenang istri tercintanya, Mumtaz Mahal. Dianggap sebagai mahakarya arsitektur Mughal dan permata seni Muslim di India.",
      facts: [
    ...
    },
    {
      ...
      description:
        "Candi Buddha terbesar di dunia, sebuah mahakarya arsitektur dari Dinasti Syailendra.",
      full_description:
        "Candi Borobudur adalah monumen Buddha Mahayana abad ke-9 di Magelang, Jawa Tengah, Indonesia. Monumen ini terdiri dari sembilan teras bertumpuk, enam persegi dan tiga bundar, diatapi oleh sebuah kubah pusat.",
      facts: [
  ...
  window.showDetail = function (id) {
    ...
    document.getElementById(
      "modal-title"
    ).innerText = `${wonder.name} - ${wonder.location}`;
    document.getElementById("modal-body").innerHTML = `
            <div class="row">
                <div class="col-lg-7 mb-3 mb-lg-0">
                    <img src="${
                      wonder.image
                    }" class="img-fluid rounded shadow-sm" alt="${wonder.name}">
                </div>
                <div class="col-lg-5">
                    ...
                    <ul class="list-unstyled">
                        ${wonder.facts
                          .map(
                            (fact) =>
                              `<li><i class="fas fa-check-circle text-success me-2"></i>${fact}</li>`
                          )
                          .join("")}
                    </ul>
                </div>
